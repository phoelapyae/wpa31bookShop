            ...
            <div class="col-12">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{$admin->name}}" class="form-control mb-1" placeholder="Enter a name">
                    </div>
                    <div class="form-group">
                        <label for="email">Email address*</label>
                        <input type="email" name="email" id="email" value="{{$admin->email}}" class="form-control mb-1" placeholder="Enter an email">
                    </div>
                    <div class="form-group">
